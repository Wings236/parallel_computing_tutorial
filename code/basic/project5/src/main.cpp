...
int main(int argc, char* argv[])
{
    ...
    int Layer_1_channles, Layer_1_rows, Layer_1_cols;
    std::cout << 1 << std::endl;
    conv2d(img_value, input_channels, input_cols, input_rows, conv_params[0], Layer_1_output, Layer_1_channles, Layer_1_rows, Layer_1_cols);
    std::cout << 7 << std::endl;
    std::cout << Layer_1_output[0] << std::endl;
